                ...
                <div class="home-tab">
                    ...
                    <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview">
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h2 class="app-page-title">Data Kritik / Saran Tiket</h2><br>
                                    <div class="row">
                                        <div class="col-1 text-center">

                                            <a href="/admin/print-all-feedback-ticket" target="_blank" target="_blank" class="btn btn-outline-info" style="border:none;text-decoration: none; color:black; padding:5px; margin: 0; " title="Cetak Semua Tiket">
                                    ...
                                    <div class="row">
                                        <div class="col-1 text-center">
                                            ...
                                            <a href="/admin/print-feedback-ticket-approved" target="_blank" class="btn btn-outline-info" style="border:none;text-decoration: none; color:black; padding:5px; margin: 0; " title="Cetak Semua Tiket">
                                                <i class="bi bi-printer" style="font-size:25px"></i></span>
                                            </a>
                                        </div>
                                        <div class="col" style="padding-top: 8px">
                                    ...
                                    <div class="row">
                                        <div class="col-1 text-center">
                                            ...
                                            <a href="/admin/print-feedback-ticket-rejected" target="_blank" class="btn btn-outline-info" style="border:none;text-decoration: none; color:black; padding:5px; margin: 0; " title="Cetak Semua Tiket">
                                                <i class="bi bi-printer" style="font-size:25px"></i></span>
                                            </a>
                                        </div>
                                        <div class="col" style="padding-top: 8px">
                                    ...
                                    <br><br><br>
                                    <h2 class="app-page-title">Filter Data Kritik / Saran Tiket</h2><br>
                                    <form action="/admin/filter-feedback-ticket-month-year" method="post" target="_blank">
                                        @csrf
                                        <div class="row">
                                    ...
                                    <hr>
                                    <br>
                                    <form action="/admin/print-feedback-karyawan" method="post" target="_blank">
                                        @csrf
                                        <div class="row">
