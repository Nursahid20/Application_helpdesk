...
<body style="padding-top: 15px;">
    <center>
        ...
        <hr>
        <h4 class="text3" style="font-weight: bold;">Laporan Data Tiket Karyawan</h4>
        ...
        <table class="table-cetak2" width="95%" collspacing="0">
            <thead>
                <tr>
                    ...
                    <th scope="coll">Prioritas</th>
                    <th scope="coll">Status</th>
                    <th scope="coll">Tanggal pengerjaan</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $tiket->prioritas->prioritas }}</td>
                    <td>
                        {{ $tiket->status->status }}
                    </td>
                    <td style="text-align: center">{{ $tiket->tanggal_mulai }} - {{ $tiket->tanggal_akhir }}</td>
                    <td style="text-align: center">
                        @if(!($tiket->file_lama == 'default.jpg'))
                        <img src="/file/{{ $tiket->file_lama }}" width="100px" alt="">
                        @endif
                    </td>
                </tr>
                @endforeach
