...
<head>
    <title>Laporan Data Biaya Perbaikan Aset Hardware</title>
    <!-- App CSS -->
...
<body style="padding-top: 15px;">
    <center>
        ...
        <hr>
        <h4 class="text3" style="font-weight: bold;">Laporan Data Biaya Perbaikan Aset Hardware
            <span style="font-weight: bold">
                @if(isset($aset[0]->asetHardware->nama))
                {{ $aset[0]->asetHardware->nama }}
                @else
                -
                @endif
            </span>
        ...
        <table class="table-cetak2" width="95%" collspacing="0">
            <thead>
                <tr>
                    <th scope="coll">No</th>
                    <th scope="coll">Tanggal Perbaikan</th>
                    <th scope="coll">Keterangan Kerusakan</th>
                    <th scope="coll">Biaya Perbaikan</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $aset->keterangan_kerusakan }}</td>
