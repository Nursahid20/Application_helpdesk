...
<body style="padding-top: 15px;">
    <center>
        ...
        <hr>
        <h4 class="text3" style="font-weight: bold;">Laporan Data Aset Hardware</h4>
        ...
        <table class="table-cetak2" width="95%" collspacing="0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $aset->serial }}</td>
                    <td>{{ $aset->status }}</td>
                    <td style="text-align: center;">{{ $aset->tanggal_awal_diterima }}</td>
