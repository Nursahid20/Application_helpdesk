...
<head>
    <title>Laporan Data Aset software</title>
    <!-- App CSS -->
...
<body style="padding-top: 15px;">
    <center>
        ...
        <hr>
        <h4 class="text3" style="font-weight: bold;">Laporan Data Aset Software</h4>
        ...
        <table class="table-cetak2" width="95%" collspacing="0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: center">{{ $aset->created_at }}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
