...
<head>
    <title>Laporan Data Aplikasi pada Hardware</title>
    <!-- App CSS -->
...
<body style="padding-top: 15px;">
    <center>
        ...
        <hr>
        <h4 class="text3" style="font-weight: bold;">Laporan Data Aplikasi pada Hardware <span style="font-weight: bold">{{ $nama_hardware->nama }} </span></h4>
        ...
        <table class="table-cetak2" width="95%" collspacing="0">
            <thead>
                <tr>
                    <th scope="coll">No</th>
                    <th scope="coll">Nama Aplikasi</th>
                    <th scope="coll">Serial</th>
                    <th scope="coll">Harga</th>
                    <th scope="coll">Tanggal Install</th>
                    <th scope="coll">Tanggal Lisensi Berakhir</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $aset->serial }}</td>
                    <td>{{ $aset->harga }}</td>
                    <td style="text-align: center">{{ $aset->tanggal_install }}</td>
                    <td style="text-align: center">
                        <?php
                        if ($aset->tanggal_lisensi_berakhir == null) {
                            echo  '-';
                        } else {
                            echo  $aset->tanggal_lisensi_berakhir;
                        }
                        ?>
                    </td>
                </tr>
