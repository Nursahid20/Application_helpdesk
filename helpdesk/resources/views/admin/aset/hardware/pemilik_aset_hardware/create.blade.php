                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="/admin/hardware-owner/{{ $data[0]->kode_hardware }}/store" method="post">
                                        @csrf
                                        <input type="hidden" name="aset_hardware_id" id="aset_hardware_id" value="{{ $data[0]->id }}">
                                        <div class="row mb-3">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-6" style="padding-right: 0px !important">
                                                <div>
                                                    ...
                                                    <input type="date" class="form-control @error('tanggal_diterima') is-invalid @enderror" name="tanggal_diterima" value="{{ old('tanggal_diterima') }}" id="tanggal_diterima" style="border-color: #ced4da; padding: 7px;">
