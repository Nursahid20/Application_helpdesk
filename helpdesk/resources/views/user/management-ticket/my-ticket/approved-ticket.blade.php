                                        ...
                                        <table id="example" class="table table-striped table-hover" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $tiket->status->status }}</td>
                                                    <td class="">
                                                        <?php
                                                        $data_progress = ProgressTiket::where('tiket_id', $tiket->id)->latest()->first();
                                                        if ($data_progress == null) {
                                                        } else {
                                                            echo $data_progress->number . '%' . '<br>';
                                                            echo $data_progress->keterangan;
                                                        }
                                                        ?>
                                                    </td>
                                                    <td class="text-center">
                                                        @if($tiket->tanggal_akhir == null)
                                                        -
                                                        @else
                                                        {{ $tiket->tanggal_akhir }}
                                                        @endif
